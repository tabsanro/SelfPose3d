...
class Human36MSSV(JointsDatasetSSV):
    def __init__(self, cfg, image_set, is_train, transform=None):
        super().__init__(cfg, image_set, is_train, FLIP_LR_JOINTS17, transform)
    ...
    def _get_cam(self, camera_param):
        ...
        our_cam = {
            ...
            "k": np.array([0., 0., 0.], dtype=np.float32),  # 왜곡 파라미터
    ...
    def _get_db(self):
        ...
        for subject in subject_list:
            ...
            for ann in annotations:
                ...
                # 관절 데이터 확인
                try:
                    joint_3d = joints[str(action_idx)][str(subaction_idx)][str(frame_idx)]
                except KeyError:
                    continue
                ...
                joints_3d = np.array(joint_3d, dtype=np.float32).reshape(-1, 3)
                ...
                # 2D 프로젝션 계산
                joints_2d = self._project_3d_to_2d(joints_3d, our_cam)
