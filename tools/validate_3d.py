...
from SelfPose3d.core.function import train_3d, validate_3d
...
def main():
    ...
    print("config.TEST.MODEL_FILE:", test_model_file)
    if test_model_file and os.path.isfile(test_model_file):
        logger.info('=> load models state {}'.format(test_model_file))
        model.module.load_state_dict(torch.load(test_model_file))
    else:
        raise ValueError('Check the model file for testing!')

    validate_3d(config, model, test_loader, final_output_dir, with_ssv)
